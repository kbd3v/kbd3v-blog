...
Posts follow a style guide (`_guide.md`): hook, solution, features, tech stack, closing. First person, conversational tone with a touch of humor and realness, 300-600 words. Use `##` for sections, bold labels in lists (`- **Label:** description`). Never use em dashes. Use periods, commas, or parentheses instead.
